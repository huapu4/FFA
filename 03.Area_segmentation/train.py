...
parser.add_argument('--valid_batch_size', help='The validation batch size.', type=int, default=20)
parser.add_argument('--num_epochs', help='The number of epochs to train for.', type=int, default=200)
parser.add_argument('--h_flip', action='store_false', help='Whether to randomly flip the image horizontally.')
parser.add_argument('--v_flip', action='store_false', help='Whether to randomly flip the image vertically.')
...
parser.add_argument('--data_shuffle', action='store_true', help='Whether to shuffle the data.')
...
parser.add_argument('--learning_rate', help='The initial learning rate.', type=float, default=5e-5)
parser.add_argument('--optimizer', help='The optimizer for training.', type=str, default='adamw',
...
model_checkpoint = tf.keras.callbacks.ModelCheckpoint(
    ...
    save_best_only=True, save_weights_only=True, period=args.checkpoint_freq, monitor='val_mean_io_u', mode='max')
...
# save weights
net.save_weights(filepath=os.path.join(
